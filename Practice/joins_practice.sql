...
SELECT * 
FROM practice.employee_salary;

SELECT * 
FROM practice.parks_departments;
...
SELECT em_de.first_name , em_de.last_name , em_sa.salary
...
SELECT  em_de_first.first_name, em_de_first.last_name , em_de_second.first_name , em_de_second.last_name
FROM practice.employee_demographics AS em_de_first
JOIN practice.employee_demographics AS em_de_second
ON em_de_first.employee_id + 1 = em_de_second.employee_id;
